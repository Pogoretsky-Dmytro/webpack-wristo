      ...
      const wristoDataTable = this.state.wristoData.map((dataElement) => {
       // console.log((dataElement.uniqueWristoId.concat(Math.random())).toString());
          ...
          return (
            ...
            <tr>
              <td key={dataElement.name.toString()}>{dataElement.name}</td>
              <td key={dataElement.simNumber.toString()}>{dataElement.simNumber}</td>
              <td key={dataElement.uniqueWristoId.toString()}>{dataElement.uniqueWristoId}</td>
              <td key={dataElement.status.toString()}>{dataElement.status}</td>
              <td key={dataElement.uniqueWristoId.concat(Math.random()).toString()}>
